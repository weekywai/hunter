...
class NSDictionary
{
	var hash_ :StringMap<Dynamic>;
	var data_ :StringMap<Dynamic>;
	...
	{
		//trace("NSDictionary :: dictionaryWithContentsOfFile - "+path);
	...
	public function loadContentsOfFile(path:String)
	{
		...
		trace("NSDictionary :: dictionaryWithContentsOfFile - "+dictstring);
	...
	public function new ()
	{
		//trace("NSDictionary :: new");
		hash_ = new StringMap<Dynamic>();
	}
	...
	function parseDictionary( xmlDict:Xml ) :StringMap<Dynamic> {
	...
	function parseArray (dictArr:Xml) :StringMap<Dynamic> {
	...
	{
		//trace("NSDictionary :: hash_ "+hash_ + " - data_ "+data_);
	}
}
