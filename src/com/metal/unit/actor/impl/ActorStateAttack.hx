...
class ActorStateAttack extends BaseActorState 
{
	...
	private function DoMelee(actor:MTActor):Void {
		var board:GameBoard = cast actor.owner.getComponent(GameBoard);
		
		//var offset:Int2D = Direction8Utils.getOffset(actor.Dir);
