 ...
 * @author li
 */
class Summon extends BevNodeTerminal
{
	private var _summonType:Int;

	public function new(debugName:String = null, summonType:Int = 0) 
	{
		super(debugName);
	...
	override function doExecute(input:BevNodeInputParam, output:BevNodeOutputParam):Int 
	{
		...
		outputData.CurrentStatus = AIStatus.Summon;
		outputData.SummonType = _summonType;
