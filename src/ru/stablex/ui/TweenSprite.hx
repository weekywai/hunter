...
*
*/
class TweenSprite extends Sprite implements IDisposer{
    ...
    *
    */
    public function tween (duration:Float, properties:Dynamic, easing:String = 'Linear.easeNone', overwrite:Bool = true, customActuator:Class<GenericActuator<TweenSprite>> = null) {
        switch(easing){
